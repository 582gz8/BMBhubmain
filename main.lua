...
local Tabs = {
    ...
    Setting = Window:AddTab({ Title = "Cài đặt farm..", Icon = "" }),
    Stats = Window:AddTab({ Title = "Điểm chỉ số", Icon = "" }),
    Player = Window:AddTab({ Title = "Local Player", Icon = "" }),
    Teleport = Window:AddTab({ Title = "Dịch chuyển", Icon = "" }),
    Fruit = Window:AddTab({ Title = "Trái ak wỷ", Icon = "" }),
    ...
    Hop = Window:AddTab({ Title = "Hop sever", Icon = "" }),
}
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Farm thông thạo trái", Default = false })
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Chỉnh máu quái để farm mastery (nên để 25% - 30%)",
        Description = "",
        Default = 25,
        Min = 0,
        Max = 100,
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Farm katakuri v1", Default = false })
...
if Third_Sea then
    ...
    local RoughSea = Tabs.Main:AddSection("Vùng biển có sấm sét")

    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Bay tàu ra biển", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = " Giết Piranha (cá điện)", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " Tự động đánh cá mập con", Default = false })
    ...
    local AutoElite = Tabs.Main:AddSection("Tự động săn elite")

    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Tự động săn elite", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Săn Sea Beast", Default = false })
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Bay tới đảo bí ẩn", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Tự động nhìn trăng và bật tộc", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự động treo đảo bí ẩn", Default = false })
ToggleMirage:OnChanged(function(Value)
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Tự động ấn phím W", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Tự động lấy lưỡi hái Hallow [a-z]", Default = false })
	...
	spawn(function()
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Tự động lấy tunsita", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Tự động thắp đuốc", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Tự động đánh nhà máy(sea 2)", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Đánh katakuri v2 [cần triệu hồi trước]", Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Mua kiếm huyền thoại (sea2)",Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Setting Farming")
 ...
 local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title = "Đánh nhanh (nên dùng)", Default = true })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xóa hiển thị sát thương (fix lag)", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Xóa mọi thông báo", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "White Screen (dùng để treo, màn hình trắng xóa)", Default = false })
...
local Pos = Tabs.Setting:AddSection("Độ xa với quái")
...
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Nâng Melee", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Nâng Defense", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Nâng Sword", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Nâng Gun", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "nâng trái", Default = false })
...
-----------------------------------------------------------------------------------------------------------------------------------------------
--Teleport
local Teleport = Tabs.Teleport:AddSection("Dịch chuyển")
...
local Mastery = Tabs.Teleport:AddSection("Dịch chuyển tới đảo")
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Tự động săn trái ác quỷ đã chọn", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Tự động quay trái", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Tự động dịch chuyển đảo tiếp", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Lấy trái cùi để mua chip", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Đánh Law", Default = false })
...
Tabs.Race:AddButton({
    Title = "Dịch chuyển tới cổng tộc",
    Description = "",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
        wait(0.1)
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Tự động win ải tộc quỷ & human", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Tự động win ải (ngoài human với quỷ)", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Tự động mua gear đi trial", Default = false })
...
local Mastery = Tabs.Shop:AddSection("Items khác")
...
local Mastery = Tabs.Misc:AddSection("Mở các bảng")

Tabs.Misc:AddButton({
	Title = "Shop bán trái ác quỷ",
	Description = "",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
local Mastery = Tabs.Misc:AddSection("Trôn trôn vn")



Tabs.Misc:AddButton({
	Title = "Mưa trái ác quỷ (fake)",
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Sea 3 lm ơn T_T")

end

if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Tìm sever full moon", Default = false })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Tìm sever có đảo bí ẩn", Default = false })
