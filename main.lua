...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "Up V4", Icon = "" }),
    Shop = Window:AddTab({ Title = "Mua Items", Icon = "" }),
...
Tabs.Status:AddParagraph({
    Title = "Điểm tím (fragment)",
    Content = "Fragments :".." "..game:GetService("Players").LocalPlayer.Data.Fragments.Value
})

Tabs.Status:AddParagraph({
    Title = "Kinh nghiệm",
    Content = "ExP Points :".." "..game:GetService("Players").LocalPlayer.Data.Exp.Value
})

Tabs.Status:AddParagraph({
    Title = "Điểm stat",
    Content = "Stats Points :".." "..game:GetService("Players").LocalPlayer.Data.Points.Value
})
...
ImageButton.Image = "rbxassetid://16667795800"

UICorner.CornerRadius = UDim.new(0, 30)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 232, 244)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(146, 255, 251)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(180, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(96, 255, 231))}
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Tự động đánh boss bột", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Đánh", Default = false })
...
if Third_Sea then
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " Đánh Shark", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Đánh Fish Crew", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "treo Sea Beast", Default = false })
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Bay tới đảo kì bí", Default = false })
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Dịch chuyển tới gear xanh", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Nhìn trăng và bật tộc", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự động farm đảo bí ẩn", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Lấy Hallow Scythe", Default = false })
	...
	spawn(function()
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Tự động gắn đuốc", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Farm nhà máy sea 2", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Đánh boss bột v2 (cần triệu hồi)", Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Mua kiếm huyền thoại(sea 2)",Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Setting Farming")
 ...
 local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title = "Fast Attack(nên sài)", Default = true })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xoá dame", Default = false })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Xoá mọi thông báo", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "White Screen (treo game)", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Mua trái đang ngắm", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "tự động lưu trữ trái", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Quay trái", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Kill Aura (Haki bá vương)", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Đảo tiếp", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Móc trái cùi để raid", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Tự động đánh Law", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Tự động đi ải cho human/quỷ", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Tự động đi ải", Default = false })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("sea3 pls")

end

if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Tìm fullmoon", Default = false })
...
-----------------------------------------------------------------------------------------------------------------------------------------------
--//function notify
function Notify(name,info,Des)
    if not game:GetService("CoreGui"):FindFirstChild("LK")  then
    print("Create Notify")
    local LK = Instance.new("ScreenGui")
    local KH = Instance.new("Frame")
    local UIListLayout = Instance.new("UIListLayout")
    LK.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    LK.Name = "LK"
    LK.Parent = game:GetService("CoreGui")
    KH.BorderSizePixel = 0
    KH.Size = UDim2.new(0, 274, 0, 302)
    KH.BorderColor3 = Color3.fromRGB(0, 0, 0)
    KH.BackgroundTransparency = 1
    KH.Name = "KH"
    KH.Position = UDim2.new(0.0133732, 0, 0.0331126, 0)
    KH.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    KH.Parent = LK
    UIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout.Padding = UDim.new(0, 5)
    UIListLayout.Name = "UIListLayout"
            UIListLayout.Parent = KH
        else
    print("Notify")
    end
    print("Create Notify : ",name,info,Des)
    ...
    MK.Size = UDim2.new(0, 0, 0, 100)
    MK.BorderColor3 = Color3.fromRGB(0, 0, 0)
    MK.Name = "MK"
    MK.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        MK.Parent = game:GetService("CoreGui").LK.KH
    UIGradient.Name = "UIGradient"
    UIGradient.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(170, 170, 255)), ColorSequenceKeypoint.new(0.158895, Color3.fromRGB(171.192, 171.192, 255)), ColorSequenceKeypoint.new(0.352332, Color3.fromRGB(172.642, 172.642, 255)), ColorSequenceKeypoint.new(0.564767, Color3.fromRGB(199.436, 199.436, 255)), ColorSequenceKeypoint.new(0.735751, Color3.fromRGB(220.383, 220.383, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255)) }
    UIGradient.Parent = MK
    UICorner.Name = "UICorner"
    UICorner.Parent = MK
    h.BorderSizePixel = 0
    h.TextYAlignment = Enum.TextYAlignment.Top
    h.BackgroundColor3 = Color3.fromRGB(219, 8, 219)
    h.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    h.TextSize = 14
    h.Position = UDim2.new(0.0328467, 0, 0.07, 0)
    h.Size = UDim2.new(0, 200, 0, 17)
    h.Name = "h"
    h.TextColor3 = Color3.fromRGB(10, 146, 236)
    h.BorderColor3 = Color3.fromRGB(229, 10, 10)
    h.Text = name
    h.BackgroundTransparency = 1
    h.TextXAlignment = Enum.TextXAlignment.Left
    h.Parent = MK
    h1.BorderSizePixel = 0
    h1.TextYAlignment = Enum.TextYAlignment.Top
    h1.BackgroundColor3 = Color3.fromRGB(235, 6, 6)
    h1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    h1.TextSize = 12
    h1.Position = UDim2.new(0.0328467, 0, 0.24, 0)
    h1.Size = UDim2.new(0, 255, 0, 68)
    h1.Name = "h1"
    h1.TextColor3 = Color3.fromRGB(243, 5, 5)
    h1.BorderColor3 = Color3.fromRGB(11, 170, 228)
    h1.Text = info
    h1.BackgroundTransparency = 1
    h1.TextXAlignment = Enum.TextXAlignment.Left
    h1.Parent = MK
    local TweenService = game:GetService("TweenService")
    TweenService:Create(MK,TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 274, 0, 100)}):Play()
    wait(Des)
    print("Wait Delete Notify")
    MK:Destroy()
    print("Success Delete")
    end
    
    Notify("Handsome guys","Thank for using script",5)
